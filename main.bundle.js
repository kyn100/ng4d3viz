...
var AppComponent = (function () {
    ...
    AppComponent.prototype.generateBarChart = function () {
        // set the dimensions and margins of the graph
        var margin = { top: 5, right: 20, bottom: 30, left: 40 };
        var width = 600 - margin.left - margin.right;
        var height = 600 - margin.top - margin.bottom;
        //create svg
        var svg = __WEBPACK_IMPORTED_MODULE_1_d3__["select"](this.element.nativeElement).append('svg')
        ...
        var xDomain = this.data.map(function (d) { return d.salesperson; });
        var yDomain = [0, __WEBPACK_IMPORTED_MODULE_1_d3__["max"](this.data, function (d) { return d.sales; })];
        // set the scale for data domain
        var x = __WEBPACK_IMPORTED_MODULE_1_d3__["scaleBand"]()
            .domain(xDomain)
            .rangeRound([0, width])
            .padding(0.2);
        var y = __WEBPACK_IMPORTED_MODULE_1_d3__["scaleLinear"]()
            .domain(yDomain)
            .range([height, 0]);
        // add the x Axis
        svg.append("g")
